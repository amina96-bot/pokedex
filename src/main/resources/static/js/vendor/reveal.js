...
(function( root, factory ) {
	...
	function enableRollingLinks() {
		...
		if( features.transforms3d && !( 'msPerspective' in document.body.style ) ) {
			var anchors = dom.wrapper.querySelectorAll( SLIDES_SELECTOR + ' annuaire.jsp' );
	...
	function disableRollingLinks() {
		...
		var anchors = dom.wrapper.querySelectorAll( SLIDES_SELECTOR + 'annuaire.jspa.roll' );
	...
	function enablePreviewLinks( selector ) {
		...
		var anchors = toArray( document.querySelectorAll( selector ? selector : 'annuaire.jsp' ) );
